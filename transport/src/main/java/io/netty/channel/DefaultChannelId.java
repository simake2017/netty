...
public final class DefaultChannelId implements ChannelId {
    ...
    static {
        int processId = -1;
        String customProcessId = SystemPropertyUtil.get("io.netty.processId");//参数 进程 id
        if (customProcessId != null) {
            try {
                processId = Integer.parseInt(customProcessId);//数字
        ...
        byte[] machineId = null;
        String customMachineId = SystemPropertyUtil.get("io.netty.machineId");//获取netty的机器ID
    ...
    public static void main(String[] args) throws Exception {
        ...
        Object bean = getRuntimeMXBean.invoke(null, EmptyArrays.EMPTY_OBJECTS);
        Method getName = runtimeMxBeanType.getMethod("getName", EmptyArrays.EMPTY_CLASSES);
        String value = (String) getName.invoke(bean, EmptyArrays.EMPTY_OBJECTS);
