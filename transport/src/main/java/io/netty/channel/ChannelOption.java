 ...
 */
/*
ChannelOption也是一个泛型类，泛型对象
ChannelOption类似于AttributeKey，也是作为一个value对象进行存储在map中，name作为key
 */

/*
    ChannelOption的泛型对象是任意类型
...
public class ChannelOption<T> extends AbstractConstant<ChannelOption<T>> {
    ...
    /*
    创建各种ChannelOption对象，并放入缓存中，这种设计有什么意义，使用枚举也可以达到相同效果
    这套常量体系

     */
//    public static final ChannelOption<ByteBufAllocator> ALLOCATORa = ChannelOption.<ByteBufAllocator>valueOf("ALLOCATOR");
//上面这里是泛型方法的正确使用方法，下面的都是简写的

    public static final ChannelOption<ByteBufAllocator> ALLOCATOR = ChannelOption.<ByteBufAllocator>valueOf("ALLOCATOR");
