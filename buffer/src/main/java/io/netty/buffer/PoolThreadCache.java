...
final class PoolThreadCache {
    ...
    /*
        ...
        numCaches --> cache的数目
        cacheSize --> 表示每个cache的大小 （单位是SizeClass）
     */
    ...
    private boolean allocate(MemoryRegionCache<?> cache, PooledByteBuf buf, int reqCapacity) {
        ...
        /**
         * 这里的cache就是 tiny 或者 small 这种具体的cache
         */
        boolean allocated = cache.allocate(buf, reqCapacity); // 这里是一个具体的分配
    ...
    /*
        SizeClass 是枚举类型 有3个值 tiny/small/normal
     */
    ...
    public static void main(String[] args) {
        Queue<Object> queue = PlatformDependent.newFixedMpscQueue(10);
        System.out.printf(queue.size() + ""); //0
