...
/**
 * netty自定义的Unpooled类，是一个不安全的操作类，用于创建netty需要的ByteBuf
 * 包括
 *
 */
public final class Unpooled {
     ...
     */
    /**
     * 零拷贝 通过 wrapp 方法 将 多个 bytebuffer进行 封装，提供统一api 主要用在unpooled中
     * @param buffers
     * @return
     */
     ...
     */
    /**
     * 创建一个新的Bytebuf，创建出的ByteBuf的长度等于各数组的长度之和
     * 内容使用system.arraycopy进行复制，readerindex与writerindex都等于0
     * @param arrays
     * @return
     */
